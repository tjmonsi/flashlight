...
exports.FB_URL   = process.env.FB_URL || 'https://nice-v1.firebaseio.com';

// The path in your Firebase where clients will write search requests
exports.FB_REQ   = process.env.FB_REQ || 'v1/searchGroup/request';

// The path in your Firebase where this app will write the results
exports.FB_RES   = process.env.FB_RES || 'v1/searchGroup/response';
...
var bonsai = process.env.BONSAI_URL;

/** ElasticSearch Settings
 *********************************************/

if( bonsai ) {
  processBonsaiUrl(exports, bonsai);
}
else {
...
exports.paths = [
  {
    path: 'v1/articleGroup/articles',
    index: 'nicev1',
    type: 'article',
    fields: ['body', 'title', 'subTitle', 'categories']
  },
  {
    path: 'v1/dataGroup/data',
    index: 'nicev1',
    type: 'data',
    fields: ['body', 'title', 'categories']
  },
  {
    path: 'v1/pageGroup/pages',
    index: 'nicev1',
    type: 'page',
    fields: ['body', 'title', 'subTitle']
  },
  {
    path: 'v1/userGroup/profiles',
    index: 'nicev1',
    type: 'profile',
    fields: ['displayName', 'email', 'firstName', 'lastName', 'body', 'address', 'categories']
  }
  // {
  //   path : "users",
  //   index: "firebase",
